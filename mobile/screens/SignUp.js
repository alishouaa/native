...
class SignUpScreen extends Component {
  ...
  validate() {
    const { name, email, password, userType, speialization, address, phone, workingHours } =
      this.state;
      ...
      <ScrollView contentContainerStyle={{ paddingVertical: 40 }}>
        ...
        <View style={styles.container}>
          ...
          <KeyboardAvoidingView behavior="padding" enabled>
            <Input onChangeText={this.changeNameHandler} value={name} placeholder="الاسم" />
            <Input
            ...
            {userType && (
              <React.Fragment>
                ...
                <Input
                  ...
                  placeholder="العنوان"
                />
                <Input onChangeText={this.changePhoneHandler} value={phone} placeholder="الهاتف" />
              </React.Fragment>
            )}
            <Button title="إنشاء" onPress={this._signUp} />
